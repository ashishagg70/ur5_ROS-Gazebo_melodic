...
class GazeboRosVacuumGripper : public ModelPlugin
{
  ...
  private: bool OnServiceCallback(gazebo_msgs::SpawnModel::Request &req,
                                 gazebo_msgs::SpawnModel::Response &res);
  private: bool OffServiceCallback(gazebo_msgs::SpawnModel::Request &req,
                                 gazebo_msgs::SpawnModel::Response &res);
  ...
  private: std::string pickup_item_name_;
